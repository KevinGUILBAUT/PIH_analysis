"""Compute linear trend features extraction on the database."""
...
def compute_linear_trends_for_patient(patient_data, 
    ...
    for original_col, signal_name in signal_mapping.items():
        ...
        signal_values = patient_data[:induction_start][original_col].values # we only want information bf induc starts
